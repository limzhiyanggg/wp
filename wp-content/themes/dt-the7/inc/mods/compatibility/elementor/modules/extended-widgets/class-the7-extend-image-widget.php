...
class The7_Exend_Image_Widget {
	...
	public function add_svg_support( $widget ) {
		...
		The7_Elementor_Widgets::update_responsive_control_fields( $widget, 'height', $control_data );
	}
	...
	private function get_inline_image_by_url( $url = null, $attr = array() ) {
		...
		return sprintf( '<span %2$s>%1$s</span>', $image_content, $this->get_attr( $attr ) );
	}
